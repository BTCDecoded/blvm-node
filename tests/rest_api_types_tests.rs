...
mod tests {
    ...
    fn test_api_error_creation() {
        let error = ApiError::new("NOT_FOUND", "Resource not found", None, None, None);
    ...
    fn test_api_error_with_details() {
        ...
        let error = ApiError::new("NOT_FOUND", "Block not found", details.clone(), None, None);
    ...
    fn test_api_error_serialization() {
        let error = ApiError::new("BAD_REQUEST", "Invalid request", None, None, None);
